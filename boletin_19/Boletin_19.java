...
public class Boletin_19 {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    matriz = obx1.crearMatriz(matriz);
                    break;
                case 2:
                    obx1.amosar(matriz);
                    break;
                case 3:
                    obx1.amosarTodo(matriz, equipo, xornada);
                    break;
                case 4:
                    mediaGolesXornada = obx1.mediaGolesXornada(matriz, mediaGolesXornada);
                    break;
                case 5:
                    mediaGolesEquipo = obx1.mediaGolesLiga(matriz, mediaGolesEquipo);
                    break;
                case 6:
                    obx1.ordenarEquipos(matriz, equipo, mediaGolesEquipo);
                    break;
                case 7:
                    obx1.mostraTablaOrdenada(matriz, equipo, xornada, mediaGolesXornada);
                    break;
                case 8:
                    obx1.totalGolesEquipo(equipo, mediaGolesEquipo);
                    break;
                case 9:
                    obx1.totalGolesXornada(equipo, xornada, matriz);
                    break;
                case 10:
                    obx1.consulta(equipo, xornada, matriz);
                    break;
                case 11:
                    obx1.sair();
            }
